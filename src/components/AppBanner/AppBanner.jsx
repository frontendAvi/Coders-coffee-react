  ...
  return <div className="container my-14">
        ...
        <div>
            <div className="space-y-6 max-w-xl mx-auto">
              ...
              className="text-center sm:px-20">Lorem ipsum dolor sit amet consectetur adipisicing. {''}</motion.p>
              {/* image links */}
              <div
              ...
              className="flex justify-center items-center gap-4">
                <a href="#"><motion.img
                  ...
                  whileInView={{opacity:1,y:0}}
                  transition={{type:"spring",stiffness:100,damping:10,delay:.8}}
                className="max-w-[150px] sm:max-w-[120px] md:max-w-[200px]" src={AppStore} alt="App Store" /></a>

                <a href="#"><motion.img
                initial={{opacity:0,y:100}}
                whileInView={{opacity:1,y:0}}
                transition={{type:"spring",stiffness:100,damping:10,delay:1}}
                className="max-w-[150px] sm:max-w-[120px] md:max-w-[200px]" src={PlayStore} alt="Play Store" /></a>  {/* icons */}
              </div>
            </div>
        </div>
        </div>
